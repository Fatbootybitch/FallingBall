PImage backpic, ballpic, netpic, welcomescreen, endscreen;
int game, score, highscore, x, y, vertical, netx[] = new int[2], nety[] =new int[2];
public void setup() {
   ...
   endscreen =loadImage("https://raw.githubusercontent.com/FatBootyBitch/FallingBall/main/giphylisa.gif");
